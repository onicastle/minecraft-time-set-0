package twilightmod.blocks.guis;
...
public class GuiPowerGenerator extends GuiContainer
{
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/guis/power_generator.png");
	private final InventoryPlayer player;
	private final TileEntityPowerGenerator tileentity;
	
	public GuiPowerGenerator(InventoryPlayer player, TileEntityPowerGenerator tileentity) 
	{
		super(new ContainerPowerGenerator(player, tileentity));
		this.player = player;
