package twilightmod.blocks.containers;
...
public class ContainerPowerGenerator extends Container
{
	private final TileEntityPowerGenerator tileentity;
	private int energy, cookTime;
	
	public ContainerPowerGenerator(InventoryPlayer player, TileEntityPowerGenerator tileentity) 
	{
